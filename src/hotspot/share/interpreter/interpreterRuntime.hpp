...
class InterpreterRuntime: AllStatic {
 ...
 public:
  ...
  static void    read_nullable_with_invalid_default(JavaThread* current, oopDesc* value, int index, Klass* field_holder);
  static void    write_nullable_with_invalid_default(JavaThread* current, oopDesc* rcv, int index, oopDesc* value);
