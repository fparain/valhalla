...
class ConstantPoolCacheEntry {
 ...
 public:
  ...
  enum {
    ...
    is_nullable_with_invalid_default_shift = 20,  // (n) is the field nullable with an invalid default value?
  ...
  void set_field(                                // sets entry to resolved field state
    ...
    bool            is_nullable_with_invalid_default // the field is nullable with aninvalid default value
  );
 ...
 public:
  ...
  bool is_nullable_with_invalid_default() const           { return (_flags & (1 << is_nullable_with_invalid_default_shift)) != 0; }
