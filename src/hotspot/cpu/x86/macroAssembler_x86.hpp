...
class MacroAssembler: public Assembler {
 ...
 virtual void check_and_handle_earlyret(Register java_thread);
  ...
  void test_klass_is_null_free(Register klass, Register temp_reg, Label& is_null_free);
  void test_klass_is_not_null_free(Register klass, Register temp_reg, Label& is_not_null_free);
  ...
  void test_field_is_inline_type(Register flags, Register temp_reg, Label& is_null_free);
  void test_field_is_not_inline_type(Register flags, Register temp_reg, Label& not_null_free);
  void test_field_is_inlined(Register flags, Register temp_reg, Label& is_inlined);
  void test_field_is_null_free(Register flags, Register temp_reg, Label& is_null_free);
  void test_field_is_not_null_free(Register flags, Register temp_reg, Label& is_not_null_free);
